...
(function (global) {
    ...
    function generateCode(node) {
        ...
        // Treat any tag that is not purely lowercase/dashed as a component so
        // "myComponent" or namespaced tags like "UI.Card" are correctly
        // resolved to functions instead of being rendered as plain DOM tags.
        var isComponent = /^[A-Z]/.test(tagName) || /[A-Z]/.test(tagName.slice(1)) || tagName.indexOf('.') !== -1;
